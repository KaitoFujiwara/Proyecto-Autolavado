...
public class Proyecto extends javax.swing.JFrame {
   ...
   // private ArrayList<Auto> autos = new ArrayList<>();
    ...
    initComponents();
    configurarSistema();
    controlador = new ControladorProyecto(this);
    LocalTime horaActual = LocalTime.now();
    DateTimeFormatter formato =
        DateTimeFormatter.ofPattern("HH:mm:ss");

     jTextField22.setText(
        horaActual.format(formato)
     );
     
     Date hoy= new Date();
     
     if(jCalendarComboBox1.getDate().after(hoy)){
         JOptionPane.showMessageDialog(null, "No se puede seleccionar una fecha posterior a hoy");
         jCalendarComboBox1.setDate(hoy);
     }
     //ImageIcon icon = new ImageIcon(getClass().getResource("/Imagen/auto.jpg"));
     //  java.awt.Image img = icon.getImage();
     //  java.awt.Image imgEscalada = img.getScaledInstance(foto.getWidth(), foto.getHeight(), java.awt.Image.SCALE_SMOOTH);
    ...
    private void configurarSistema() {
        ...
        jComboBox1.addItem("Transferencia");

        jTextField20.setEditable(false);
jTextField20.setText(LocalDateTime.now().format(DateTimeFormatter.ofPattern("HH:mm:ss")));

jButton2.addActionListener(e -> limpiarAuto());
jButton1.addActionListener(e -> limpiarServicio());
jButton12.addActionListener(e -> limpiarReservacion());
jButton10.addActionListener(e -> limpiarTicket());
        jTabbedPane1.setTitleAt(0, "Cliente");
        jTabbedPane1.setTitleAt(1, "Auto");
        jTabbedPane1.setTitleAt(2, "Servicio");
        jTabbedPane1.setTitleAt(3, "Reservación");
        jTabbedPane1.setTitleAt(4, "Ticket");
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addContainerGap(3166, Short.MAX_VALUE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 3075, Short.MAX_VALUE)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jButton6)
                            .addComponent(jButton5))
                        .addGap(135, 135, 135))))
        ...
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(318, 6, 124, -1));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(0, 153, 0));
        jLabel6.setText("ID-Auto:");
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(42, 98, 97, -1));
        ...
        jPanel2.add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(145, 102, 362, -1));

        jLabel7.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(204, 204, 0));
        jLabel7.setText("     Marca: ");
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(42, 142, 97, -1));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 0, 0));
        jLabel8.setText("   Modelo:");
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(42, 201, 97, -1));

        jLabel9.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel9.setText("    Color:");
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(42, 259, 97, -1));
        ...
        jPanel2.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(145, 146, 362, -1));
        jPanel2.add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(145, 205, 362, -1));
        ...
        jPanel2.add(jTextField7, new org.netbeans.lib.awtextra.AbsoluteConstraints(145, 263, 362, -1));

        jButton4.setText("Guardar");
        jButton4.addActionListener(this::jButton4ActionPerformed);
        jPanel2.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(553, 3246, -1, -1));

        jButton2.setText("Limpiar");
        jPanel2.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(643, 3246, -1, -1));

        jTabbedPane2.addTab("Registro de Autos ", jPanel2);

        jTabbedPane1.addTab("Autos", jTabbedPane2);
        ...
        jLabel12.setText("Nombre-Servicio:");
        ...
        jCalendarComboBox1.addPropertyChangeListener(this::jCalendarComboBox1PropertyChange);
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addContainerGap(3084, Short.MAX_VALUE))
        );

        jTabbedPane3.addTab("Registro de Servicio ", jPanel3);

        jTabbedPane1.addTab("Servicio", jTabbedPane3);
        ...
        jLabel22.setText("    ID-Auto:");

        jLabel23.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel23.setForeground(new java.awt.Color(255, 0, 0));
        jLabel23.setText("Cita-Servicio:");
        ...
        jLabel28.setText("Confirmación:");

        jRadioButton1.setText("Confirmado");

        jRadioButton2.setText("Por Confirmar ");

        jRadioButton3.setText("No confirmado");
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tarjeta", "Efectivo", "Transferencia" }));
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jButton11)
                    .addComponent(jButton12))
                .addContainerGap(3042, Short.MAX_VALUE))
        );

        jTabbedPane5.addTab("Registro de Citas ", jPanel5);

        jTabbedPane1.addTab("Reservaciones", jTabbedPane5);
        ...
        jLabel17.setText("ID-Servicio:");

        jLabel18.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel18.setText("ID-Auto:");

        jLabel19.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel19.setText("ID-Cliente:");

        jLabel35.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel35.setText("ID-Ticket:");
        ...
        jTabbedPane4.addTab("Registro de Detalles ", jPanel4);

        jTabbedPane1.addTab("Detalles", jTabbedPane4);
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tarjeta", "Efectivo", "Transferencia" }));
        ...
        jButton9.setText("Generar ticket");
        jButton9.addActionListener(this::jButton9ActionPerformed);

        jButton10.setText("Limpiar");

        jLabel38.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel38.setForeground(new java.awt.Color(102, 204, 0));
        jLabel38.setText("ID Reservacion");
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addContainerGap(2864, Short.MAX_VALUE))
        );

        jTabbedPane6.addTab("Registro de Ticket", jPanel6);

        jTabbedPane1.addTab("Ticket", jTabbedPane6);
    ...
    private void jCalendarComboBox1PropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jCalendarComboBox1PropertyChange
        if("date".equals(evt.getPropertyName())){
            Date hoy= new Date();
            if(jCalendarComboBox1.getDate().after(hoy)){
                JOptionPane.showMessageDialog(null, "No puedes seleccionar fecha posterior a hoy");
                jCalendarComboBox1.setDate(hoy);
            }
        }
    ...
    try {
        ...
        int idAuto = Integer.parseInt(jTextField14.getText().trim());
        int idServicio = Integer.parseInt(jTextField15.getText().trim());

        Cliente cliente = controlador.buscarCliente(idCliente);
        Auto auto = controlador.buscarAuto(idAuto);
        Servicio servicio = controlador.buscarServicio(idServicio);

        if (cliente == null || auto == null || servicio == null) {
            JOptionPane.showMessageDialog(this, "Cliente, auto o servicio no encontrado");
            return;
        }

        String tipoPago = jComboBox2.getSelectedItem().toString();

        LocalDateTime fechaHora = LocalDateTime.now();

        Reservacion reservacion = new Reservacion(
                controlador.getReservaciones().size() + 1,
                cliente,
                auto,
                servicio,
                fechaHora,
        ...
        controlador.agregarReservacion(reservacion);

        JOptionPane.showMessageDialog(this, "Reservación guardada con ID: " + reservacion.getId());

    } catch (NumberFormatException e) {
        JOptionPane.showMessageDialog(this, "Los ID deben ser numéricos");
    }
}
    ...
    private void guardarCliente() {
        try {
            ...
            if (nombre.isEmpty() || telefono.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Llena nombre y teléfono");
                return;
            }
    ...
    private void guardarAuto() {
        try {
            ...
            String modelo = jTextField6.getText().trim();
            String color = jTextField7.getText().trim();

            if (modelo.isEmpty() || color.isEmpty()) {
                JOptionPane.showMessageDialog(this, "Llena modelo y color");
                return;
            }

            Auto auto = new Auto(id, color, modelo);
            controlador.agregarAuto(auto);

            JOptionPane.showMessageDialog(this, "Auto guardado");

        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "El ID del auto debe ser numérico");
        }
    }
    ...
    private void guardarServicio() {
        ...
        String descripcion = jTextField10.getText().trim();
        double precio = Double.parseDouble(jTextField11.getText().trim());
        int duracion = Integer.parseInt(jTextField12.getText().trim());

        if (nombre.isEmpty() || descripcion.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Llena nombre y descripción");
            return;
        }

        Servicio servicio = new Servicio(id, nombre, descripcion, precio, duracion);
        controlador.agregarServicio(servicio);

        JOptionPane.showMessageDialog(this, "Servicio guardado");

    } catch (NumberFormatException e) {
        JOptionPane.showMessageDialog(this, "ID, precio y duración deben ser numéricos");
    }
}

private void generarTicket() {
    try {
        int idReservacion = Integer.parseInt(jTextField19.getText().trim());

        Reservacion r = controlador.buscarReservacion(idReservacion);

        if (r == null) {
            JOptionPane.showMessageDialog(this, "No existe esa reservación");
            return;
        }

        jTextField18.setText(String.valueOf(r.getId()));
        jTextField21.setText(r.getFechaEntrega().toLocalDate().toString());
        jTextField22.setText(r.getFechaEntrega().toLocalTime().toString());
        jTextField23.setText(String.valueOf(r.getTotal()));
        jComboBox1.setSelectedItem(r.getTipoPago());

        jTextArea1.setText(
                "========= TICKET LAVA AUTOS =========\n"
                + "ID Reservación: " + r.getId() + "\n"
                + "Cliente: " + r.getCliente().getNombre() + "\n"
                + "Teléfono: " + r.getCliente().getTelefono() + "\n"
                + "Auto: " + r.getAuto().getModelo() + "\n"
                + "Color: " + r.getAuto().getColor() + "\n"
                + "Servicio: " + r.getServicio().getNombre() + "\n"
                + "Fecha entrada: " + r.getFechaEntrega().toLocalDate() + "\n"
                + "Hora entrada: " + r.getFechaEntrega().toLocalTime() + "\n"
                + "Pago: " + r.getTipoPago() + "\n"
                + "Total: $" + r.getTotal() + "\n"
                + "====================================="
        );
        ...
        JOptionPane.showMessageDialog(this, "El ID de reservación debe ser numérico");
    }
}
